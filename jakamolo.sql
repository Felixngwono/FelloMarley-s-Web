...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 18, 2025 at 09:57 AM
...
(1, 'pbkdf2_sha256$260000$R91kWn8igEXz5iycZGZxJr$Y3gKrV3WNRqQcIJAyfXcsKfjqEJAbSRiq7KfoVxBrag=', '2025-03-08 20:06:01.190723', 1, 'StoryTeller', '', '', 'fellomarley@gmail.com', 1, 1, '2025-02-17 15:30:37.955084'),
...
INSERT INTO `storyteller_blogpost` (`id`, `title`, `content`, `created_at`, `updated_at`, `image`, `author_id`, `status`) VALUES
(1, 'Waititu crisis', 'Waititu to pay 53.3million or serve 12yrs in prison', '2025-02-18 17:49:54.167512', '2025-02-18 17:49:54.167512', 'blog_images/Buore.JPG', NULL, NULL),
(2, 'AU election', 'Come 15th Feb, Raila is voted to be the AU chairman. Its also been announced if Raila doesnt win the election, it will be a calamicious crisis to doc Samoei', '2025-02-18 17:55:26.354138', '2025-02-18 17:55:26.354138', 'blog_images/judiciary_F5nziLd.webp', NULL, NULL),
(3, 'FelloMarley the programmer', 'My first website to bulid was about\' youth empowerment\"', '2025-02-18 17:59:51.140891', '2025-02-20 08:48:25.380439', 'blog_images/flag.jpeg', NULL, NULL),
(6, 'zxcdfgvb', 'xzxdfgbv', '2025-02-20 13:39:59.277793', '2025-02-20 13:39:59.277793', 'blog_images/carrots_tjrk5F4.jpg', NULL, NULL),
(8, 'dsfg', 'zxxcdffgg', '2025-03-04 06:39:44.359155', '2025-02-25 00:00:00.000000', 'blog_images/Rivals.jpg', 1, 'drafted'),
(9, 'Sudan Tension', 'south Sudan leaders agrees to easen tension in the country. The country has been faced with severe internal attacks, leadership ideologies', '2025-03-04 09:44:04.223519', '2025-03-04 00:00:00.000000', 'blog_images/dandora.jpg', 2, 'published');
...
INSERT INTO `storyteller_event` (`id`, `title`, `description`, `image`, `date`, `guests`, `category_id`, `host_id`, `location_id`, `end_date`, `start_date`) VALUES
(1, 'Tech Innovators Conference 2025', 'Join us for the annual Tech Innovators Conference, where industry leaders from around the world gather to discuss the latest trends in technology, innovation, and entrepreneurship. This year’s conference will feature keynote speakers from leading tech companies, panel discussions, and networking opportunities. Don’t miss out on this amazing event that brings together visionaries, entrepreneurs, and tech enthusiasts to explore the future of technology.', 'events_images/1730310059669.jpg', '2025-02-18 18:15:33.658572', 'Vicky Amanda', 1, 1, 2, NULL, '2025-03-03 09:55:15.620868'),
(3, 'Arts in the Musoleum Kisumu', 'Different arts are yet to be improvised in kisumu come 18th/08', 'events_images/im.jpg', '2025-02-20 15:45:39.248081', 'lawrence Kosgei', 2, 1, 3, NULL, '2025-03-03 09:55:15.620868');
...
INSERT INTO `storyteller_job` (`id`, `title`, `company`, `location`, `job_type`, `description`, `requirements`, `application_link`, `posted_at`, `due_at`) VALUES
(1, 'm,jkhuijhyujh', 'njhuyiojkl,', 'kjmhyu879iol', 'full-time', 'm,kjnhuy8iujk', 'm,njbhvfyulj', NULL, '2025-03-03 08:58:49.452886', NULL),
(2, 'nnnnnn', 'jgfytuj', 'jhgytuj', 'part-time', 'ljhgb', 'mjkhgftyujh', 'https://github.com/Felixngwono/Personal-Web', '2025-03-03 09:01:05.940380', NULL),
(3, 'Youth Employment programs', 'open source', 'Kisumu, Nairobi and Kisii County', 'contract', 'this jobs have been set to create emplyment opportunities among the youths and reduce the crime rates due to frequent enemployment rates.', 'ID card', 'https://github.com/Felixngwono/Personal-Web', '2025-03-03 20:15:33.712353', NULL),
(4, 'mnbvb', 'mnbv', 'bvn', 'full-time', 'nbgvfygh', 'm,njhjm', 'https://github.com/Felixngwono/Personal-Web', '2025-03-04 15:21:34.175718', NULL);
